...
#开机自检各等级监控
KERN_BUFF_ALERT			=	IM_GROUP_DEVELOPER+IM_GROUP_SUPPORT
KERN_BUFF_CRIT			=	IM_GROUP_DEVELOPER+IM_GROUP_SUPPORT

#日志各等级监控
CHECKLOG_ERR			=	IM_GROUP_DEVELOPER
CHECKLOG_CRIT			=	IM_GROUP_DEVELOPER+IM_GROUP_SUPPORT
CHECKLOG_ALERT			=	IM_GROUP_DEVELOPER+IM_GROUP_SUPPORT
CHECKLOG_EMERG			=	IM_GROUP_DEVELOPER+IM_GROUP_SUPPORT
